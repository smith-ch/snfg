...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      <div className="bg-gradient-to-r from-primary/10 to-secondary/10 py-4 relative overflow-hidden shadow-lg rounded-lg mx-4 -mt-8 z-10">
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between">
            ...
            <Button size="sm" className="btn-shine gradient-animated" asChild>
        ...
        <div className="absolute -top-3 -right-3 w-12 h-12 bg-primary/10 rounded-full blur-xl animate-pulse-slow"></div>
        <div className="absolute -bottom-3 -left-3 w-12 h-12 bg-secondary/10 rounded-full blur-xl animate-pulse-slow"></div>
      </div>
